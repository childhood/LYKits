...
@implementation LYMapViewProvider
...
- (void)init
{
	...
	LYAnnotation* annotation = [[LYAnnotation alloc] init];
...
{
    if(![annotation isKindOfClass:[LYAnnotation class]])	 // Don't mess user location
        return nil;
