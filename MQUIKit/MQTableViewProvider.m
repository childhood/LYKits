...
#define k_mq_table_cell_height				64
#define k_mq_table_cell_image_gap			14
#define k_mq_table_header_height_plain		21
#define k_mq_table_footer_height_plain		21
#define k_mq_table_header_height_grouped	46
#define k_mq_table_footer_height_grouped	21

@implementation MQTableViewProvider
	...
	if (self != nil)
	{
		...
		switch (view.style)
		{
			case UITableViewStylePlain:
				table_header_height = k_mq_table_header_height_plain;
				table_footer_height = k_mq_table_footer_height_plain;
				break;
			case UITableViewStyleGrouped:
				table_header_height = k_mq_table_header_height_grouped;
				table_footer_height = k_mq_table_footer_height_grouped;
				break;
		}
		...
		cell_height			= k_mq_table_cell_height;
		cell_bg				= nil;
		cell_bg_top			= nil;
		cell_bg_bottom		= nil;
		cell_bg				= nil;
...
{
	[self apply_theme_color:[UIColor blackColor] on:[UIColor clearColor]];
	//view.backgroundColor = [UIColor colorNamed:@"mq_theme_table_table01_bg.png"];
	cell_bg = @"mq_theme_table_metal01_cell.png";
	cell_bg_top = @"mq_theme_table_metal01_cell1.png";
	cell_bg_bottom = @"mq_theme_table_metal01_cell2.png";
	header_label.textColor = [UIColor whiteColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (cell == nil)
	{
		...
		if (the_image != nil)
		{
			...
			{
				cell.imageView.image = [UIImage imageWithCGImage:the_image.CGImage scale:(the_image.size.height / (cell_height - k_mq_table_cell_image_gap)) orientation:UIImageOrientationUp];
				//	NSLog(@"used 4.0 scaling: %@, %f", cell.imageView.image, the_image.size.height / (cell_height - k_mq_table_cell_image_gap));
		...
		if (image_url != nil)
		{
			cell.imageView.image = [UIImage imageNamed:@"mq_blank_64x64.png"];
			image_view = [[MQAsyncImageView alloc] initWithFrame:cell_image_rect];
