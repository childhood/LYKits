...
#import "MQMusicJukeboxTableViewController.h"
//#import "AddMusicAppDelegate.h"

@interface MQMusicJukeboxController : UIViewController <MPMediaPickerControllerDelegate, MQMusicJukeboxTableViewControllerDelegate, AVAudioPlayerDelegate> {
